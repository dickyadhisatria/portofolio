...
export const experience: Experience[] = [
  {
    id: 'gap',
    company: 'Professional Development Period',
    role: 'Job Search & Skill Enhancement',
    period: 'Feb 2026 – Present',
    location: 'Cianjur, Indonesia',
    stack: ['Go', 'Java', 'Cybersecurity'],
    description: `Dedicated this professional development period to advancing industry readiness. Successfully navigated PT KCIC's multi-stage recruitment up to the final medical check-up before process discontinuation. Strengthened Cybersecurity skills through IBM SkillsBuild, and learning Go and Java/Spring Boot to build scalable enterprise backend architectures.`,
    metrics: ['Advanced as a Final-Stage Candidate in PT KCIC Multi-Stage Recruitment Process', 'Certified in IBM Cybersecurity Coursework', 'Expanded Backend Capabilities in Go and Java for Scalable Enterprise Architectures'],
    category: 'other',
    type: 'experience',
  },
  {
  ...
  },
  {
    ...
    location: 'Depok (Remote), Indonesia',
...
export const projects: Project[] = [
  {
    ...
    location: 'Aceh (Remote), Indonesia',
...
export const certifications: Certification[] = [
  { id: 'software-eng', name: 'Software Engineer', issuer: 'HackerRank', date: 'Jun 2026',
     svgPath: '/certificates/hackerrank-software-engineer.svg',
      verifyUrl: 'https://www.hackerrank.com/certificates/77f4057ee8a1' },
  { id: 'go-basic', name: 'Go (Basic)', issuer: 'HackerRank', date: 'Jun 2026',
     svgPath: '/certificates/hackerrank-go-basic.svg',
      verifyUrl: 'https://www.hackerrank.com/certificates/e295e5b4269a' },
  { id: 'cybersec-pan', name: 'Cybersecurity Foundations', issuer: 'Palo Alto Networks', date: 'Jun 2026',
     svgPath: '/certificates/palo-alto-palo-alto-networks-cybersecurity-foundations.svg',
      verifyUrl: 'https://coursera.org/share/ed7e031b19a60e4a46600b3cfd89a427' },
  { id: 'cybersec-ibm', name: 'Cybersecurity Fundamentals', issuer: 'IBM', date: 'May 2026',
     svgPath: '/certificates/ibm-cybersecurity-fundamentals.svg',
      verifyUrl: 'https://www.credly.com/badges/1de7e35b-bd7f-4247-a7c8-195fdfa82869' },
  { id: 'js-inter', name: 'JavaScript (Intermediate)', issuer: 'HackerRank', date: 'Sep 2024',
     svgPath: '/certificates/hackerrank-javascript-intermediate.svg',
      verifyUrl: 'https://www.hackerrank.com/certificates/11223344556677889900' },
  { id: 'rest-inter', name: 'REST API (Intermediate)', issuer: 'HackerRank', date: 'Sep 2024',
     svgPath: '/certificates/hackerrank-rest-api-intermediate.svg',
      verifyUrl: 'https://www.hackerrank.com/certificates/00998877665544332211' },
  { id: 'ptesol', name: 'PTESOL - English Proficiency', issuer: 'Indonesia University of Education', date: 'Jul 2024',
     svgPath: '/certificates/balai-bahasa-upi-sertifikat-ptesol.svg',
      verifyUrl: 'https://www.indonesiauniversityofeducation.ac.id/certificates/ptesol' },
  { id: 'sql-adv', name: 'SQL (Advanced)', issuer: 'HackerRank', date: 'Dec 2023',
     svgPath: '/certificates/hackerrank-sql-advanced.svg',
      verifyUrl: 'https://www.hackerrank.com/certificates/a383cf97c20d' },
  { id: 'problem-solving', name: 'Problem Solving (Basic)', issuer: 'HackerRank', date: 'Dec 2023',
     svgPath: '/certificates/hackerrank-problem-solving-basic.svg',
      verifyUrl: 'https://www.hackerrank.com/certificates/0f41ae8b9802' },
  { id: 'python-ibm', name: 'Python for Data Science, AI & Development', issuer: 'IBM', date: 'Jul 2023',
     svgPath: '/certificates/ibm-python-for-data-science-ai-development.svg',
      verifyUrl: 'https://coursera.org/share/fa5b302d86751723f1ed8d13d72d392e' },
  { id: 'thrive-telkomsel', name: 'THRIVE Tech Enthusiast - Software Development', issuer: 'Telkomsel', date: 'Oct 2022',
     svgPath: '/certificates/telkomsel-software-development.svg',
      verifyUrl: 'https://drive.google.com/file/d/15Dqgutbyw9NCEYc1XL-tKm9a18nAUzYU/view?usp=sharing' },
  { id: 'js-binar', name: 'JavaScript Back End Developer', issuer: 'Binar Academy', date: 'Jul 2022',
     svgPath: '/certificates/binar-academy-backend-javascript.svg',
      verifyUrl: 'https://drive.google.com/file/d/1yFZvwII9wvWKvrsQ8x-FRWPo_SypCH6n/view?usp=sharing' },
  { id: 'node-basic', name: 'Node.js (Basic)', issuer: 'HackerRank', date: 'Jul 2022',
     svgPath: '/certificates/hackerrank-nodejs-basic.svg',
      verifyUrl: 'https://www.hackerrank.com/certificates/472d386310fc' },
  { id: 'comp-net', name: 'Computer Networking', issuer: 'Google', date: 'Jun 2022',
     svgPath: '/certificates/google-computer-networking.svg',
      verifyUrl: 'https://coursera.org/share/823876392f0efec4939e00c7ae093b95' },
  { id: 'tech-support', name: 'Technical Support Fundamentals', issuer: 'Google', date: 'Jun 2022',
     svgPath: '/certificates/google-technical-support-fundamentals.svg',
      verifyUrl: 'https://coursera.org/share/d9923a59b10f0f87d2eaf9fe4427d358' },
];
