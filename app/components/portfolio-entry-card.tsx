        ...
        <div className="min-w-0 space-y-3">
          <div className="flex items-center gap-2">
            <Badge tone={accentMap[entry.category]}>
              <span aria-hidden="true">{categoryEmoji[entry.category]}</span> {entry.category}
            </Badge>
            {entry.url ? (
    ...
    <div className="group/parent relative perspective-[800px]">
      ...
      <AnimatePresence>
        {hovered && entry.url ? (
          ...
          >
            <div className="flex items-center gap-2">
              <span aria-hidden="true" className="text-lg">{categoryEmoji[entry.category]}</span>
            ...
            <div className="mt-2 flex items-center gap-2 border-t border-white/10 pt-2">
              ...
              <span aria-hidden="true" className="text-[10px] text-zinc-600">&rarr;</span>
            </div>
          </motion.div>
        ) : null}
      </AnimatePresence>
